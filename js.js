        ...
        let eliminated = [];      // respuestas quitadas por el 50:50
        let answersShown = false; // ya se ven las 4 respuestas
        let gameOver = false;     // la partida ha terminado por fallo
        let answering = false;    // bloquea dobles clics al confirmar
        ...
        function triggerButtonsFadeIn() {
            ...
            for (let i = 0; i < 4; i++) {
                const t = setTimeout(() => {
                    ...
                    // Si el 50:50 ya la eliminó, aparece apagada y sin poder pulsarse
        ...
        function checkAnswer(idx) {
            ...
            // Bloquea todas las respuestas para evitar dobles clics
        ...
        function closeCountdownModal() {
            ...
            // Solo retoma el suspense si ya hay respuestas en pantalla
        ...
        function use5050() {
            ...
            eliminated.forEach(i => {
                const btn = document.getElementById(`btn${i}`);
                // Si ya estaba visible, la apaga; si no, la dejará apagada al aparecer
